...
def parse_args(input_args=None):
    ...
    parser.add_argument("--block_number", type=int, default=-1, help="number_of_block")
...
def main(args):
    ...
    block_number_collection = range(10,38)  # Responsible for style

    target = []
    for block_number in block_number_collection:
        target.extend([
            f"single_transformer_blocks.{block_number}.attn.to_q",
            f"single_transformer_blocks.{block_number}.attn.to_k",
            f"single_transformer_blocks.{block_number}.attn.to_v",
            f"single_transformer_blocks.{block_number}.attn.to_out.0",
        ])
